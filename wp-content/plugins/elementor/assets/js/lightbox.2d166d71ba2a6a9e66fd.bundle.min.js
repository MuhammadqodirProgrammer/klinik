      ...
      e.exports = elementorModules.ViewModule.extend({
        ...
        getShareLinks() {
          const { i18n: e } = elementorFrontend.config,
            ...
            l = s("<div>", { class: i.slideshow.shareLinks }),
        ...
        setSlideshowContent(e) {
            ...
            (e.slides.forEach((e) => {
              ...
              if (e.video) {
                ...
                const i = this.isFontIconSvgExperiment
                    ? n.loading.element
                    : "<i>",
                  l = s("<div>", { class: r.playButton }).html(
                    s(i)
          ...
          p.onShow = async () => {
            ...
            i || (t.navigation = { prevEl: m, nextEl: g }),
        ...
        playSlideVideo() {
          ...
          a.onApiReady((e) => {
            "youtube" === l
              ? this.prepareYTVideo(e, r, i, n, o)
              : "vimeo" === l && this.prepareVimeoVideo(e, t, i, n, o);
          }),
